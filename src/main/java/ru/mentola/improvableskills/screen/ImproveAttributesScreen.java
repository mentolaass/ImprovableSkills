...
public final class ImproveAttributesScreen extends Screen {
    ...
    private void renderDialog(DrawContext context, double scaledWidth, double scaledHeight) {
        ...
        double y = scaledHeight / 2 - 150 / 2;
        RenderUtil.renderRectangle(context, x, y, 200, 150, new Color(40, 40, 40, 200));
        ...
        RenderUtil.renderBorder(context, x, y, 200, 150, 1, new Color(50, 50, 50));
        int textY = 10;
        ...
        if (playerData != null) {
            ...
            RenderUtil.renderRectangle(context, x + 10, y + 150 - 30, 180, 20, new Color(30, 30, 30, alpha));
            RenderUtil.renderBorder(context, x + 10, y + 150 - 30, 180, 20, 1, new Color(50, 50, 50, alpha));
            context.drawText(MinecraftClient.getInstance().textRenderer, textAcceptBtn, (int) (x + 10 + (double) 180 / 2) - textRenderer.getWidth(textAcceptBtn) / 2, (int) (y + 150 - 23), new Color(190, 190, 190, alpha).getRGB(), false);
            if (attributesChanged) {
                Text textNeedPoints = Text.of(Constants.NEED.getString() + " " + pointsToUpgrade + " " + Constants.POINTS.getString());
                context.drawText(MinecraftClient.getInstance().textRenderer, textNeedPoints, (int) (x + 10 + (double) 180 / 2) - textRenderer.getWidth(textNeedPoints) / 2, (int) (y + 150 - 45), new Color(190, 190, 190, alpha).getRGB(), false);
            }
        }
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        if (button == 0) {
            ...
            if (playerData != null) {
                ...
                if (Util.pointedTo(x + 10, y + 150 - 30, 180, 20, mouseX, mouseY)) {
                    if (playerData.getPoints() > pointsToUpgrade) {
                        for (Attribute<?> tempAttribute : tempAttributes) {
